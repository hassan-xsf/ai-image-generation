import { Img, useCurrentFrame, staticFile, interpolate, Audio as RemoAudio } from 'remotion';
...
export const MyVideo: React.FC<{ images: string[], captions: Caption[], audioName: string }> = ({ images, captions, audioName }) => {
    ...
    useEffect(() => {
        ...
        const handleLoadedMetadata = () => {
            ...
            console.log('Audio duration:', audio.duration); // Now this will show the correct duration
        };
